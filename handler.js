...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'This command can only be used by _*OWWNER!1!1!*_ subscribe  YouTube channel *MR RAVANAN*',
    owner: 'This command can only be used by _*Owner Bot*_! subscribe YouTube channel *MR RAVANAN*',
    mods: 'This command can only be used by _*Moderator*_ ! subscribe YouTube channel *MR RAVANAN*',
    premium: 'This command is for members only _*Premium*_! subcribe YouTube channel *MR RAVANAN*',
    group: 'This command can only be used in groups! make your own bot to subscribe YouTube channel _*MR RAVANAN*_',
    private: 'This command can only be used in Private Chats! make your own bot to subscribe YouTube channel _*MR RAVANAN*_',
    admin: 'This command is for *Admin* grup! make your own bot to subscribe YouTube channel _*MR RAVANAN*_',
    botAdmin: 'Make bots as *Admin* to use this command! make your own bot to subscribe YouTube channel _*MR RAVANAN*_',
    unreg: 'Please register to use this feature by typing:\n\n*#daftar name.age*\n\nExample: *#daftar Ranjith.18* make your own bot to subscribe YouTube channel _*MR RAVANAN*_'
  }[type]
